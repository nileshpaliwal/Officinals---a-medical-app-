...
public class DoctorHome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        if(user!=null){
            ...
            Mobile = (TextView) header.findViewById(R.id.mobilenumber);
            Mobile.setText(mobile);
        }
        if(user==null){
            Intent intent = new Intent(DoctorHome.this,DoctorOrUser.class);
    ...
    AdapterView.OnItemClickListener myOnItemClickListener  = new AdapterView.OnItemClickListener(){
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
          ...
          /*  String prompt = (String)parent.getItemAtPosition(position);*/
            ...
            if(video!=null)
            {
                MediaController mediaController = mediaController = new MediaController(DoctorHome.this);// new FullScreenMediaController(getApplicationContext());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.filter) {
            Intent intent = new Intent(DoctorHome.this,FilterActivity.class);
            startActivity(intent);
            return true;
        }
        if(id == R.id.upload_video){
            Intent intent = new Intent(DoctorHome.this,Video_Uploa_By_Doctors.class);
            startActivity(intent);
        }
...
// Attempt to start an activity that can handle the Intent
            ...
            Intent intent = new Intent(DoctorHome.this,About.class);
            startActivity(intent);


        } else if (id == R.id.nav_contact) {

            Intent intent = new Intent(DoctorHome.this,Contact.class);
            startActivity(intent);

        } else if (id == R.id.nav_signout) {

            FirebaseAuth.getInstance().signOut();
            Intent intent = new Intent(DoctorHome.this,DoctorSignIn.class);
            startActivity(intent);
            SharedPreferences sp = getSharedPreferences("doc_or_user", Activity.MODE_PRIVATE);
            SharedPreferences.Editor editor = sp.edit();
            editor.putInt("key", 0);
